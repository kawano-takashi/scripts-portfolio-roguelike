...
{
    public sealed class ItemUnequippedEvent : IRoguelikeEvent
    {
        ...
        public ItemUnequippedEvent(ActorId actorId, ItemInstanceId itemId, ItemId itemType, EquipmentSlot slot)
        {
            ActorId = actorId;
            ItemId = itemId;
            ItemType = itemType;
